# stats-cookbook
I accumulated these code snippets while completing required coursework for my degree in applied statistics. I have them organized by course (one file per course) and then by analysis task (one chunk per task). Files include language meant to accompany analyses.
