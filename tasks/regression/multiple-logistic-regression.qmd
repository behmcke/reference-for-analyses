...
description: "Model a binary outcome from several predictors; test with Wald and likelihood-ratio tests."
categories: [Regression, "Model Fitting", "Model Selection"]
---

::: {.callout-note title="Introduction"}
Use multiple logistic regression to model a binary outcome from several
predictors, interpreting coefficients as odds ratios.
:::
...
- [Simple Logistic Regression](simple-logistic-regression.qmd)
- [Model Selection](model-selection.qmd)

*Data: `CH14PR14.txt` — see [sources & provenance](../../data/README.md#regression).*
