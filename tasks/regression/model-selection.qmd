...
description: "Choose predictors with best-subsets, adjusted R², Mallows' Cp, BIC, and stepwise search."
categories: [Regression, "Model Selection"]
---

::: {.callout-note title="Introduction"}
Use best-subsets and stepwise criteria to settle on a parsimonious set of
predictors rather than keeping every candidate.
:::
...
- [Check Model Fit](check-model-fit.qmd)

*Data: `CH09PR10-1.txt` — see [sources & provenance](../../data/README.md#regression).*
