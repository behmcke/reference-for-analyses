...
description: "Define treatment contrasts that capture the comparisons of primary interest."
categories: [Experiments, "Experimental Design", "Inference & Prediction"]
---

::: {.callout-note title="Introduction"}
Set up contrasts to express the specific treatment comparisons you care about —
main effects, pairwise differences, or interactions.
:::
