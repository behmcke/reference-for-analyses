...
description: "Test and visualize a two-factor interaction; switch to a cell-means model when it matters."
categories: [Experiments, "Model Fitting", Visualization]
---

::: {.callout-note title="Introduction"}
Test for a two-factor interaction and read an interaction plot; when interaction
is present, compare treatments rather than individual factor levels.
:::
...
*Data: `weld.strength.txt` — see [sources & provenance](../../data/README.md#experiments).*
