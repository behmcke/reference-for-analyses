...
description: "Build family-wise confidence intervals for contrasts with Bonferroni and Scheffé adjustments."
categories: [Experiments, "Inference & Prediction"]
---

::: {.callout-note title="Introduction"}
Use Bonferroni or Scheffé multipliers to control the family-wise error rate
across several contrast intervals at once.
:::
